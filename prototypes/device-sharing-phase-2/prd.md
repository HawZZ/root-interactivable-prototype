...
| P2-AC-03 | 从共享管理点击“添加共享”；覆盖区域/邮箱/手机号、本人/重复/未注册/地区校验失败/格式、BBM 勾选及确认、同日重新发起、重试；检查右上角客服入口 | 直接进入添加共享。US/CA +1、CN +86、其他邮箱；非法格式页内阻断。合法提交后未注册时在本页 Toast“该账号尚未注册，请对方注册后再发起共享”，地区校验失败时 Toast“该账号暂时无法共享，请检查账号信息”；两者均保留账号和勾选，且无关系/邀请/通知/占额。实际提交才记 A01。自研/Tuya 直接建联，Meari 接受后核实建联；二期不设同设备同账号每日次数上限，终态后可同日重发；客服图标展示并调用既有客服组件，不新增客服流程或埋点 | [添加共享](https://hawzz.github.io/root-interactivable-prototype/prototypes/device-sharing-phase-2/?page=add-share) |
