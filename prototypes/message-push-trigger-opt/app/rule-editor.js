...
const steps=[
  [1,"基础信息","分类、优先级、模板"],[2,"触发与范围","事件、目标、地域"],[3,"时间与频控","窗口、时区、节流"],[4,"生命周期","结束、上限、熔断"]
];
