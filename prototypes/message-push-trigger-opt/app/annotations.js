...
const notes={
  ...
  language:[
    ...
    ["保存检查","统一多语言 > 保存检查","只检查当前草稿中已选语言。校验不通过时不会修改已保存的产品语言配置。","product-language-validation"]
  ],
  ruleLanguage:[
    ["当前规则","规则多语言 > 说明","此抽屉只编辑从列表点击的那一条规则，不会同时打开其他规则的内容。","rule-language-intro"],
    ["多语言内容","规则多语言 > 编辑区","Title 和 Body 分两行维护；显示的语言范围只读取当前产品已经保存的语言选择。","rule-language-matrix"],
    ["保存检查","规则多语言 > 保存检查","只检查当前产品已保存语言。保存成功后才更新这条规则的语言数量与 English 标题；取消不保存。","rule-language-validation"]
  ]
};
