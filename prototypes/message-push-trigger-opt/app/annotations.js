...
const notes={
  ...
  rule1:[
    ...
    ["分类与优先级","步骤1 > 分类/优先级","说明：messageCategory 与 priority 独立。默认 P2；P0 会触发关键语言阻断和更快升级。","priority-field"],
  ...
  rule4:[
    ...
    ["投递级硬顶","步骤4 > 安全上限","说明：任何优先级和升级倍率都不得超过 1 push/5min/user/rule。","delivery-cap"],
    ["升级目标与聚合","步骤4 > 升级路径","说明：接收人用 userId 配置；为空回退系统管理员。同一接收人 60s 内跨规则升级聚合。","escalation"],
