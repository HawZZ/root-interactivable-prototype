...
export const productSources={
  "prod-s12":{properties:[{id:"milkLevel",name:"储奶量",type:"number",unit:"ml",operators:[">=",">","=","<=","<"],example:"180"},{id:"pumpMode",name:"吸乳模式",type:"enum",options:["standard","stimulation","quiet"],operators:["=","!="]},{id:"paused",name:"设备暂停",type:"boolean",operators:["=","!="]}],countdowns:[{id:"feed-reminder",name:"喂养提醒",status:"enabled",deviceCapability:"verified",cycleContract:"verified",timerInstanceId:"timer-feed-01",cycleId:"cycle-2026-08-03-01",durationMinutes:60}],consumables:[]},
  "prod-air-p3":{properties:[{id:"pm25",name:"PM2.5",type:"number",unit:"μg/m³",operators:[">=",">","=","<=","<"],example:"75"}],countdowns:[{id:"filter-dry",name:"滤芯干燥倒计时",status:"enabled",deviceCapability:"pending",cycleContract:"missing",durationMinutes:120}],consumables:[{id:"filter",name:"HEPA 滤芯",unit:"%",deviceCapability:"verified"},{id:"carbon",name:"活性炭滤芯",unit:"%",deviceCapability:"pending"}]}
};
