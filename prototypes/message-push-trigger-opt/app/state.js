...
export const newRule=()=>({id:"",productId:"prod-s12",name:"",category:"事件通知",triggerType:"device",propertyId:"milkLevel",operator:">=",propertyValue:"180",cloudCountdownId:"feed-reminder",cloudThresholdMinutes:"15",consumableId:"",consumableEvent:"low",timeStart:"00:00",timeEnd:"23:59",reminderMode:"each",minIntervalMinutes:"30",deliveryTarget:"messageCenter",presetLinkId:"message-center"});

export const rules=[
  {id:"R-2048",productId:"prod-s12",name:"储奶量过高提醒",product:"S12 Pro 吸乳器",category:"事件通知",trigger:"设备：储奶量 ≥ 180 ml",title:"Milk overflow detected",languages:"1",strategy:"逐条发送 · 消息中心",status:"启用",updated:"2026-08-12 14:10",triggerType:"device",propertyId:"milkLevel",operator:">=",propertyValue:"180",timeStart:"00:00",timeEnd:"23:59",reminderMode:"each",deliveryTarget:"messageCenter",presetLinkId:"message-center"},
  {id:"R-2047",productId:"prod-air-p3",name:"滤芯寿命不足提醒",product:"Cozy Air P3",category:"事件通知",trigger:"耗材：HEPA 滤芯不足",title:"Filter life is low",languages:"1",strategy:"仅发送首条 · 12 小时 · 系统通知",status:"启用",updated:"2026-08-12 13:10",triggerType:"consumable",consumableId:"filter",consumableEvent:"low",timeStart:"08:00",timeEnd:"22:00",reminderMode:"discard",minIntervalMinutes:"720",deliveryTarget:"systemNotification",presetLinkId:"message-center"},
  {id:"R-2046",productId:"prod-s12",name:"喂养提醒即将到期",product:"S12 Pro 吸乳器",category:"耗材通知",trigger:"云端：喂养提醒 ≤ 0 分钟",title:"Feeding reminder is due",languages:"1",strategy:"同日合并 · 消息中心",status:"草稿",updated:"2026-08-12 11:26",triggerType:"cloud",cloudCountdownId:"feed-reminder",cloudThresholdMinutes:"0",timeStart:"00:00",timeEnd:"23:59",reminderMode:"each",deliveryTarget:"messageCenter",presetLinkId:"message-center"}
];
